...
<template>
  <main class="home" :class="{ 'detail-open': selectedPokemon }">
    <svg class="icon-sprite-defs" aria-hidden="true" focusable="false">
      <defs>
        <symbol id="energy-water" viewBox="0 0 192 203">
        ...
        <symbol id="energy-fire" viewBox="0 0 229 239">
        ...
        <symbol id="energy-grass" viewBox="0 0 216 242">
        ...
        <symbol id="energy-fighting" viewBox="0 0 201 220">
        ...
        <symbol id="energy-steel" viewBox="0 0 238 208">
        ...
        <symbol id="energy-dark" viewBox="0 0 226 196">
        ...
        <symbol id="energy-dragon" viewBox="0 0 217 223">
        ...
        <symbol id="energy-fairy" viewBox="0 0 223 213">
        ...
        <symbol id="energy-normal" viewBox="0 0 206 232">
